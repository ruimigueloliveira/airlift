...
public class MainPlane {
	...
	public static void main(String[] args) {
		...
		try
		{ planeInt = (PlaneInt) UnicastRemoteObject.exportObject (plane, portNumb);
		}
		catch (RemoteException e)
		...
		try
		{ reg.bind (nameEntryObject, planeInt);
		}
		catch (RemoteException e)
		{ GenericIO.writelnString ("Planeregistration exception: " + e.getMessage ());
		e.printStackTrace ();
		System.exit (1);
		}
		...
		try
		{ while (!serviceEnd)
			synchronized (Class.forName ("serverSide.main.MainPlane"))
			{ try
			{ (Class.forName ("serverSide.main.MainPlane")).wait ();
			}
		...
		{ GenericIO.writelnString ("The data type MainPlane was not found (blocking)!");
		e.printStackTrace ();
		System.exit (1);
		}
	...
	public static void shutdown ()
	{
		...
		try
		{ synchronized (Class.forName ("serverSide.main.MainPlane"))
			{ (Class.forName ("serverSide.main.MainPlane")).notify ();
			}
		}
		catch (ClassNotFoundException e)
		{ GenericIO.writelnString ("The data type MainPlane was not found (waking up)!");
		e.printStackTrace ();
		System.exit (1);
		}
	}
