...
import serverSide.sharedRegions.ServiceProviderDestination;
...
public class MainDestinationAirport {
	...
	public static void main(String[] args) {
		...
		DestinationAirport destAirport = new DestinationAirport(repos);
		DestinationAirportProxy destProxy = new DestinationAirportProxy(destAirport);
		...
		while(!serviceEnd){
			sconi = scon.accept();
			sp = new ServiceProviderDestination(sconi, destProxy);
			sp.start();
		}
		scon.end();
