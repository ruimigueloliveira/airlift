 ...
 * of a shared region.
 */
public class ServiceProviderDeparture extends Thread {
     ...
     */
    private final IntDepartureAirport intSR;
     ...
     */
    public ServiceProviderDeparture(ServerCom com, IntDepartureAirport intSR){
        this.com = com;
        this.intSR = intSR;
    }
